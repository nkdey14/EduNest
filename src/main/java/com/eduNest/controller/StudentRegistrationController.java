	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(session.getAttribute("email") != null) {
				...
				System.out.println("Fetched userId is: "+ userId);
				
				ssi.saveStudentDetails(firstName, lastName, email, mobile, city, course, userId);
				
				request.setAttribute("msg", "Student Record Saved Successfully!!");
